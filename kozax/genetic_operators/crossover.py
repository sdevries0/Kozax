...
def check_different_trees(carry: Tuple[Array, Array, Array, Array, Array, float, Array, Array]) -> bool:
    ...
    """
    parent1, parent2, child1, child2, _, _, _, _, _, counter = carry
...
def safe_crossover(carry: Tuple[Array, Array, Array, Array, Array, float, Array, Array]) -> Tuple[Array, Array, Array, Array, Array, float, Array, Array]:
    ...
    """
    parent1, parent2, _, _, keys, reproduction_probability, node_ids, operator_indices, num_ouputs, counter = carry
    ...
    return parent1, parent2, child1, child2, keys, reproduction_probability, node_ids, operator_indices, num_ouputs, counter+1
